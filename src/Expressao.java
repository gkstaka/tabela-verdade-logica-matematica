...
public class Expressao {
    ...
    private HashMap<Character, ArrayList<Integer>> posicaoProposicoes;
    ...
    public Expressao(String expressao) throws ExcecaoCaracteres {
        ...
        this.numeroProposicoes = contarProposicoes();
        this.posicaoProposicoes = new HashMap<>();
        setPosicaoProposicoes();
        this.valorProposicoes = new ArrayList<ArrayList<Boolean>>();
    }

    private int contarProposicoes() {
    ...
    private void setPosicaoProposicoes() {
        for (int i = 0; i < this.expressao.length; i++) {
            char c = this.expressao[i];
            if (! (c == '^' || c == 'v' || c == '~')) {
...
//                System.out.println(this.expressao[i]);
    ...
    public void montarTabela() {
        ...
        for (int i = numeroLinhas - 1; i >= 0; i--) {
            ...
            for (int j = numeroBitsSignificativos - 1; j >= 0; j--) {
...
//    private boolean avaliarLinha(ArrayList<Boolean>)
